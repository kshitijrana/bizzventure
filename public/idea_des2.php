...
session_start();
$message = "";
if(isset($_SESSION["des2_wrong"]))
{
	$message = "Please enter the details again.";
	unset($_SESSION["des2_wrong"]);
}
?>
<!doctype html>
<html>
...
<section class="panel color4-alt">
								...
								<div class="inner columns divided">
									<div class="span-3-25">
									<h2>Idea Details:</h2>
        <form method="POST" action="../includes/check_idea_des2.php" id="reg_det">
	<?php echo $message;?>
	<div class="field">
	<textarea type="text" name="competition" id="competition" required placeholder="Competition (min. 100 characters)" pattern="^\s*[a-zA-Z0-9/!\\-#:;%,.()@\s']{10,}" form="reg_det"></textarea></div>
	<div class="field">
	<textarea type="text" name="risk" id="risk" required placeholder="Risk/Opportunity (min. 100 characters)" pattern="^\s*[a-zA-Z0-9/\s/!\\-#@%$:;,.()']{10,}" form="reg_det"></textarea></div>
	<div class="field">
	<textarea type="text" name="mark_strgy" id="mark_strgy" required placeholder="Marketing Strategy (min. 100 characters)" pattern="^\s*[a-zA-Z0-9/\s/!\\-#@:;,.()']{10,}" form="reg_det"></textarea></div>
